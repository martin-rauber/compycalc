...
# 3)  enter F14C EC and OC raw data and add desired slope
          ##EC: import from csv
          F14C_EC_raw_data = read.csv("EC-F14C-raw-data.csv", header = TRUE)
          F14C_EC_raw_data = F14C_EC_raw_data[,]
          #OR enter here manually
          #F14C_EC_raw_data = c()
          
          ##OC: import from csv
          F14C_OC_raw_data = read.csv("OC-F14C-raw-data.csv", header = TRUE)
...
#Version info in pdf
compycalc_version = "pdf generated by COMPYCALC version 1.1.3"
